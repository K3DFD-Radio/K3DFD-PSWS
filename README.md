...
### Project Overview  
The goal of the PSWS project is to create a geographically distributed, multi-instrument system for ground-based space environment measurements. Data from this node is aggregated into a central HamSCI database for space science research, specifically for analyzing phenomena like **Traveling Ionospheric Disturbances (TIDs)**. Technically, it is a wide-spectrum receiving system that reports WSPR/FST4w and WWV/WWVH and CHU time standard signal Doppler-shift monitoring data in the Digital RF _DRF_ format.  This data is useful for studying the behavior of the ionosphere.  
...
This repository documents the construction of a RX888 WSPRDaemon SDR Personal Space Weather Station (PSWS) node located in maidenhead grid FN20lb at the QTH of [K3DFD](https://www.qrz.com/db/K3DFD) in the Fox Chase section of NorthEast Philadelphia, Pa. This PSWS does not incorporate WSPRsonde, a VLF receiver or a Magnetometer.   
